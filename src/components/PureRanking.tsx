                ...
                overallRanking.map((player, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`relative z-10 font-mono text-2xl md:text-5xl tabular-nums tracking-tighter shrink-0 pr-4 md:pr-8`} style={{ color: isWin ? "rgb(202,253,92)" : "rgb(232,85,168)" }}>
                        {isWin ? '+' : ''}{profitStr}
                      </div>
                    </div>
                  );
                     ...
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-4">
                        {m.records.map((r, idx) => (
                           <div key={idx} className="flex justify-between items-center group/item">
                             ...
                             <span className={`font-mono tabular-nums text-sm`} style={{ color: r.score >= 0 ? "rgb(202,253,92)" : "rgb(232,85,168)" }}>
